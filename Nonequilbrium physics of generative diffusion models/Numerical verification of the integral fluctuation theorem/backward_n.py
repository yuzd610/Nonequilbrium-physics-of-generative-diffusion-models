...
for n in range(0,10001,100):
    ...
    # Initial distribution of sampling inverse process
    ...
    Sm = Sm(X, ds, mu1, T)
    # Calculate the entropy production by the system
...
plt.ylabel('$\left\langle {{e^{ - \Delta {S_{tot}}}}} \\right\\rangle $',fontsize=25)
